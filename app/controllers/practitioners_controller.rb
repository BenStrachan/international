class PractitionersController < ApplicationController
  ...
  private
    ...
    def practitioner_params
      params.require(:practitioner).permit(:first_name, :last_name, :active, :education, :profession, :provider_number, :email, :phone, :mobile, :address1, :address2, :city, :state, :postcode, :country, :summary, :business_id, :business_name)
    end
end
